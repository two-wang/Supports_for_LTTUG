function [X,Fmin] = fun_hierarchical_optimization_traditional(electric_database_original,G)
    accuracy = 0.00001;
    % 对节点11进行优化操作
    node_Arr = electric_database_original(electric_database_original(:,28)==11,:);
    P_ABC_0 = zeros(3,24);
    [x,Fmin(11,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    ...
    [x,Fmin(10,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(9,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(8,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';

    % 对节点6进行优化操作
    node_Arr = electric_database_original(electric_database_original(:,28)==6,:);
    P_ABC_0 = zeros(3,24);
    [x,Fmin(6,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(5,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(4,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(3,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';

    % 对节点7进行优化操作
    node_Arr = electric_database_original(electric_database_original(:,28)==7,:);
    P_ABC_0 = zeros(3,24);
    [x,Fmin(7,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(2,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    ...
    [x,Fmin(1,:)] = ga_fun_Creat_original(node_Arr,P_ABC_0,G,accuracy);
    electric_database_original(node_Arr(:,1),29) = x';
    % 输出相别
